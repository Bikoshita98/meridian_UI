/**
 * Wire protocol between client and server. Hand-mirrored from
 * `server/src/protocol.ts` — no shared npm package at this scale (see BUILD_PROMPT.md's Folder
 * Layout note). Keep the two in sync by hand when editing either one.
 */
